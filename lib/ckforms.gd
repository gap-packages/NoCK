...
##   (as in Corollary 1 [ours])  wanish (taking q_1,...,q_m and permutation of p_1,...p_l)
...
##      2p_1-1,...,2p_l-1 are degrees generating vector space P_G (see section 4.2 in [ours])
##
...
##
##  return rational function obtaint form right side of (1) in [ours]
